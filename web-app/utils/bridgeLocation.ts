...
class bridgeLocation {
   ...
   * @param location
   */
  static getCurrentLocation = async (location: any) => {
    return new Promise((resolve, reject) => {
      location.requestSingleLocation((error: any, mapLocation: any) => {
   ...
   * @param location
   */
  static startLoopLocation = (location: any) => {
   ...
   * @param location
   */
  static stopLoopLocation = (location: any) => {
   ...
   */
  static addListenerLocation = async (params: any) => {
          ...
          if (result.name === 'locationChange') {
            ...
            if (error) {
              ...
              if (orderId === this.locationsMap.orderId) {
                ...
                console.error(
                  'addListenerLocation orderId 不一致',
                  orderId,
                  this.locationsMap.orderId,
                );
              }
              resolve(location);
            }
