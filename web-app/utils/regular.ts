...
let regular = {
   ...
   * @param str: string
   */
  phoneNumCheck: function (str: any) {
   ...
   */
  idCardCheck: function (arrIdCard: any) {
    let tag = false;
    let sigma = 0;
   ...
   */
  showEnumLabel: function (code: any, enumList: any) {
    let obj = enumList.find((item: any) => item.code === code);
